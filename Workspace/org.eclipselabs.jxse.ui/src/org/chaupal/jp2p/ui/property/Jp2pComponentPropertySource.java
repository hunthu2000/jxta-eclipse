...
public class Jp2pComponentPropertySource implements IPropertySource {
	...
	private IJp2pComponent<?> source;

	public Jp2pComponentPropertySource( IJp2pComponent<?> source, String defaultText ) {
		super();
