...
public class ConnectivityPart implements Runnable {
    ...
    public void createPartControl(Composite parent) {
		selectionService.addSelectionListener(new ISelectionListener() {
			...
			public void selectionChanged( MPart part, Object selection) {
				...
				if ( part instanceof ConnectivityPart )
					return;
	 ...
	 */
	void showSelection( Object selection) {
	...
	protected void refresh(){
		...
		Display.getDefault().asyncExec(new Runnable() {
			...
			public void run() {
            	...
            	//TODO setContentDescription( msg );
    ...
    public class RdvEventMonitor implements RendezvousListener {
        ...
        public RdvEventMonitor( ConnectivityPart inCM) {
        }
