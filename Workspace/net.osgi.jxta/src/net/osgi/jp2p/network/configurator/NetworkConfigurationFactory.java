 ...
 *******************************************************************************/
package net.osgi.jp2p.network.configurator;
...
import net.osgi.jp2p.network.http.Http2Preferences;
import net.osgi.jp2p.network.http.HttpPreferences;
import net.osgi.jp2p.network.multicast.MulticastPreferences;
import net.osgi.jp2p.network.security.SecurityPreferences;
import net.osgi.jp2p.network.tcp.TcpPreferences;
...
public class NetworkConfigurationFactory extends
	...
	protected IJp2pComponent<NetworkConfigurator> onCreateComponent( IJp2pPropertySource<IJp2pProperties> properties) {
		...
		try {
			...
			SeedListFactory slf = (SeedListFactory) super.getBuilder().getFactory( Components.SEED_LIST.toString() );
			if( slf != null ){
