...
public class JxseStartupService extends AbstractActivator implements IJxseService<ContainerBuilder>{
	...
	public JxseStartupService( ContainerBuilder container, JxseStartupPropertySource source ) {
		this.source = source;
