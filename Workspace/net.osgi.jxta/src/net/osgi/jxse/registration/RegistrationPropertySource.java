...
public class RegistrationPropertySource extends AbstractJxseWritePropertySource<RegistrationPropertySource.RegistrationProperties>
{
	...
	public RegistrationPropertySource( IJxsePropertySource<?,IJxseDirectives> parent) {
		this( Components.REGISTRATION_SERVICE.toString(), parent );
	}


	public RegistrationPropertySource( String componentName, IJxsePropertySource<?,IJxseDirectives> parent) {
		super( componentName,parent );
		this.fillDefaultValues();
	}

	protected void fillDefaultValues() {
		this.setManagedProperty( new ManagedProperty< RegistrationProperties, Object>( RegistrationProperties.WAIT_TIME, 60000, true ));
		this.setManagedProperty( new ManagedProperty< RegistrationProperties, Object>( RegistrationProperties.PEER_ID, null, true ));
		this.setManagedProperty( new ManagedProperty< RegistrationProperties, Object>( RegistrationProperties.ATTRIBUTE, null, true ));
		this.setManagedProperty( new ManagedProperty< RegistrationProperties, Object>( RegistrationProperties.WILDCARD, null, true ));
		this.setManagedProperty( new ManagedProperty< RegistrationProperties, Object>( RegistrationProperties.THRESHOLD, 1, true ));
	}
	...
	@Override
	public boolean validate(RegistrationProperties id, Object value) {
		// TODO Auto-generated method stub
		return false;
	}
