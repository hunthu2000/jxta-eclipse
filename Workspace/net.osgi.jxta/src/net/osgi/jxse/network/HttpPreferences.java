...
public class HttpPreferences implements INetworkPreferences {
	...
	public int getStartPort(){
		return ( int )this.source.getProperty( NetworkConfiguratorProperties.HTTP_8START_PORT);
	}

	public void setStartPort( int port ){
		this.source.setProperty( NetworkConfiguratorProperties.HTTP_8START_PORT, port );
	}
	...
	public int getEndPort(){
		return ( int )this.source.getProperty( NetworkConfiguratorProperties.HTTP_8END_PORT);
	}

	public void setEndPort( int port ){
		this.source.setProperty( NetworkConfiguratorProperties.HTTP_8END_PORT, port );
	}
