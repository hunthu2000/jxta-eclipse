...
public class HttpModuleService extends AbstractModuleComponent<ServletHttpTransport> {

	public static final String S_RESOURCE_LOCATION = "/Services/net.jxta.platform.Module";

    private final static transient Logger logger = Logger.getLogger( HttpModuleService.class.getName());
    
    public HttpModuleService( HttpPropertySource source ) {
		super(source, new ServletHttpTransport());
	}
