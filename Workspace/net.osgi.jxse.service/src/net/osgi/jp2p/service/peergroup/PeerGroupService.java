 ...
 *******************************************************************************/
package net.osgi.jp2p.service.peergroup;

import net.jxta.peergroup.PeerGroup;
import net.osgi.jp2p.component.AbstractJp2pService;
import net.osgi.jp2p.factory.IComponentFactory;
import net.osgi.jp2p.peergroup.PeerGroupPropertySource.PeerGroupProperties;

public class PeerGroupService extends AbstractJp2pService<PeerGroup>{
