...
import net.osgi.jp2p.discovery.DiscoveryPreferences;
import net.osgi.jp2p.discovery.DiscoveryPropertySource;
...
import net.osgi.jp2p.network.NetworkManagerPreferences;
...
import net.osgi.jp2p.network.configurator.OverviewPreferences;
...
import net.osgi.jp2p.pipe.PipePropertySource;
...
import net.osgi.jp2p.registration.RegistrationPropertySource;
import net.osgi.jp2p.seeds.SeedInfo;
import net.osgi.jp2p.seeds.SeedListPropertySource;
import net.osgi.jp2p.service.advertisement.ChaupalAdvertisementFactory;
import net.osgi.jp2p.service.discovery.ChaupalDiscoveryServiceFactory;
import net.osgi.jp2p.service.osgi.Jp2pFactoryPetitioner;
import net.osgi.jp2p.service.pipe.ChaupalPipeFactory;
...
import net.osgi.jp2p.service.xml.XMLPropertySourceBuilder.Groups;
import net.osgi.jp2p.utils.StringDirective;
import net.osgi.jp2p.utils.StringStyler;
import net.osgi.jp2p.utils.Utils;
import net.osgi.jp2p.utils.io.IOUtils;

public class XMLPropertySourceBuilder implements ICompositeBuilder<Jp2pServiceContainer> {
	...
	public XMLPropertySourceBuilder( String bundleId, Class<?> clss, ContainerBuilder container ) {
		this( bundleId, clss, S_DEFAULT_LOCATION, container );
	}

	protected XMLPropertySourceBuilder( String bundleId, Class<?> clss, String location, ContainerBuilder builder ) {
		this.clss = clss;
...
class JxtaHandler extends DefaultHandler{
	...
	public void startElement(String uri, String localName, String qName, 
		...
		Jp2pFactoryPetitioner petitioner = Jp2pFactoryPetitioner.getInstance();
		factory = petitioner.getFactory(StringStyler.styleToEnum(qName));
		if( factory != null ){
			node = this.processFactory(attributes, node, factory);
			return;
		}else{
