...
import net.osgi.jp2p.service.activator.AbstractJxseBundleActivator;
...
public class Jp2pDSComponent extends AbstractAttendeeProviderComponent {
	...
	protected Jp2pDSComponent( AbstractJxseBundleActivator activator ) {
		this( S_IJXSE_CONTAINER_PACKAGE_ID, S_IJXSE_TOKEN, activator);
	}

	protected Jp2pDSComponent( String introduction, String token, AbstractJxseBundleActivator activator ) {
		this.token = token;
