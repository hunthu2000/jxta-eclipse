...
public class ContextOption extends TemplateOption {
	 ...
	 */
	public ContextOption(BaseOptionTemplateSection section, String pageName, String title ) {
		super(section, pageName, title);
	}
	...
	protected void init(){
		JxseContextPropertySource ps = new JxseContextPropertySource( null, null);
